...
return channel.guild.channels.cache.find(x => x.name == "protection_log").send({ embeds: [ancient] });
...
let ancientGuardLog = await channel.guild.channels.cache.find(x => x.name == "protection_log").send({ embeds: [ancient], components: [row] });
