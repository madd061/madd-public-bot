...
.setDescription(`
${entry.executor} üyesi rol güncelledi

> rolü eski haline getirip yetkiliyi jail attım. Kalsın orda aklı başına gelene kadar Tarih: \`${moment(Date.now()).format("LLL")}\`
