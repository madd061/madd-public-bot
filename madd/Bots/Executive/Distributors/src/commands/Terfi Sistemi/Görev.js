...
const { Hello , gorevli, welcome2, Tac, welcome1 ,rewards , fill, empty, fillstart, emptyend, fillend, red } = require("../../../../src/configs/emojis.json")
...
`**İnvite Görev Durumu :** 
${gorevli} ${progressBar(gorevData ? gorevData.invite : 0, 10, 10)} \`${total} (${total}/10)\` 
` : "";
          //
...
`**Kayıt Görev Durumu :**  
${welcome2} ${progressBar(kayitgData ? kayitgData.kayit : 0, 10, 10)} \`${kayittotal} (${kayittotal}/10)\`
` : "";
          //
...
`**Mesaj Görev Durumu :**  
${Tac} ${progressBar(mesajData ? mesajData.mesaj : 0, 500, 5)} \`${mesajtotal} (${mesajtotal}/500)\`
` : "";
          //
...
`**Taglı Üye Durumu :**  
${welcome1} ${progressBar(tagData ? tagData.tagli : 0, 5, 5)} \`${tagTotal} (${tagTotal}/5)\`
` : "";
