...
module.exports = {
    conf: {
      aliases: ["seslog","slog"],
      name: "slog",
      help: "slog <ancient/ID>",
      category: "owner",
    },

  run: async (client, message, args, embed, prefix) => {
        if (!message.member.permissions.has(PermissionsBitField.Flags.Administrator) && !ancientcim.owners.some(x => message.member.roles.cache.has(x))) {
