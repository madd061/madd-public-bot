...
module.exports = {
    ...
    run: async (client, message, args, embed, prefix) => {
        ...
        afkUsers.forEach((user, index) => {
            afkListEmbed.setDescription(`${client.emojis.cache.find(x => x.name === "ancient_nokta")} \`${message.guild.name}\` **Adlı Sunucumuzda [AFK] Olan Kullanıcıların Hepsini Aşağıda Listeler.**
