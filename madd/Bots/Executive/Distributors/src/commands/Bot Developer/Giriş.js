...
client.on('interactionCreate', async (interaction) => {
  if (interaction.customId === 'kabul') {
    const modal = new ModalBuilder()
      ...
      const ancient = new TextInputBuilder()
          .setCustomId('isim')
          .setLabel('İsim veya Nickname')
          .setStyle(TextInputStyle.Paragraph)
          .setMinLength(2)
          .setMinLength(2)
          .setPlaceholder("İsim ve yaşınızı giriniz. Örn: ancient 20")
      
          const AOne = new ActionRowBuilder().addComponents(ancient);
    ...
    const modal = new ModalBuilder()
      ...
      const ancient = new TextInputBuilder()
          ...
          const AOnee = new ActionRowBuilder().addComponents(ancient);
