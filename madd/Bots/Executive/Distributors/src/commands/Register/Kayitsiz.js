...
module.exports = {
 ...
 const logEmbed = new EmbedBuilder()
  ...
  if (client.channels.cache.find(c => c.name === "indifferent_log")) client.channels.cache.find(c => c.name === "indifferent_log").send({ embeds: [logEmbed] })
    ...
    member.setNickname(`${member.user.username.includes(ayar.ikinciTag) ? ayar.ikinciTag : (ayar.ikinciTag ? ayar.ikinciTag : (ayar.ikinciTag || ""))} İsim `)
    message.react(green)
